  ...
  const [categoryCount, setCategoryCount] = useState({entertainment:0, food:0, travel:0});
    ...
    useEffect(() => {
      ...
      if(expenseList.length>0){
        setExpense(expenseList.reduce((accumulator, currentVal) => accumulator + Number(currentVal.price), 0));

      }else{
        setExpense(0);
      }

      let foodvar = 0, entertainmentvar = 0, travelvar = 0, foodCount = 0, entertainmentCount = 0, travelCount = 0;
      ...
      console.log("food count " + foodCount + " entrtnment count " + entertainmentCount + " travelCount " + travelCount);
    ...
    return (<>
      <div className={styles.container}>
        ...
        handleClick={
         ...
         //console.log("hello"+isOpenBalance);
        }
        }
        />
        ...
        <Piecharts 
      data={[{name: "Food", value: expenseCategory.food }, {name: "Entertainment", value: expenseCategory.entertainment }, {name: "Travel", value: expenseCategory.travel},]}
         />         
      ...
      <Transactions expenseListprop={expenseList} setExpenseListprop={setExpenseList} balanceprop={balance} setBalanceprop={setBalance} />
      ...
      <BarChart data={[
        ...
        <Modal isOpen={isOpenExpense} setIsOpen={setIsOpenExpense}>
          <Addexpense setIsOpenModal={setIsOpenExpense} setBalance={setBalance}
          balance={balance}
